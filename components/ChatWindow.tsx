  ...
  return (
    ...
    >
      ...
      <div className="relative flex min-h-0 min-w-0 flex-1 overflow-hidden">
        ...
        >
          <div style={{ minWidth: 0, padding: `0 ${CHAT_COLUMN_PADDING}px` }}>
            <div ref={messageContentRef} onPointerUp={captureQuotedSelection} style={{ width: "100%", minWidth: 0, maxWidth: "var(--chat-content-max-width, 1230px)", margin: "0 auto" }}>
            {(() => {
              let lastUserIdx = -1;
      ...
      <div className="relative shrink-0">
        {isEmptyNew && (
          <div className="mx-auto mb-3 w-full" style={{ maxWidth: "var(--chat-content-max-width, 1230px)", paddingLeft: 32, paddingRight: isMobile ? 32 : 68 }}>
